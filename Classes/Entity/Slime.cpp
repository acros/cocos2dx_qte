...
Slime::Slime() :mAttackState(AttackState::AS_READY),m_CanTriggerQTE(true)
{
...
bool Slime::init()
{
	...
	rigidBody->setCollisionCallback(CC_CALLBACK_1(Slime::qteTriggerCallback, this));
...
void Slime::qteTriggerCallback(const Physics3DCollisionInfo &ci)
{
